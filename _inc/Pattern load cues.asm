...
; ---------------------------------------------------------------------------
	...
	dc.w PLC_EPZ-ArtLoadCues, PLC_EPZ2-ArtLoadCues, PLC_EPZAnimals-ArtLoadCues
	dc.w PLC_INZ-ArtLoadCues, PLC_INZ2-ArtLoadCues, PLC_INZAnimals-ArtLoadCues
; ---------------------------------------------------------------------------
...
PLC_Main:	dc.w 3
		...
		dc.w $F400
		dc.l Nem_Lives		; lives	counter (MAYBE UNUSED I FORGOT)
		dc.w $FA80
		dc.l Nem_Ring		; rings
		dc.w $D940
		dc.l Nem_Points		; points from enemy (UNUSED)
		dc.w $D800			
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
PLC_GameOver:	dc.w 0
		dc.l Nem_GameOver	; game/time over (UNUSED)
		dc.w $ABC0
; ---------------------------------------------------------------------------
; Pattern load cues - Green Hill (Bright Sky Zone)
; ---------------------------------------------------------------------------
PLC_GHZ:	dc.w $A
		...
		dc.w 0
		dc.l Nem_Crabmeat	; crabmeat enemy (UNUSED)
		dc.w $8000
		...
		dc.w $A660
PLC_GHZ2:	dc.w 5
		dc.l Nem_Swing		; swinging platform (UNUSED)
		dc.w $7000
		dc.l Nem_Bridge		; bridge (UNUSED)
		dc.w $71C0
		dc.l Nem_SpikePole	; spiked pole (UNUSED)
		dc.w $7300
		dc.l Nem_Ball		; giant	ball (UNUSED)
		dc.w $7540
		dc.l Nem_GhzWall1	; breakable wall (UNUSED)
		dc.w $A1E0
		dc.l Nem_GhzWall2	; normal wall (UNUSED)
		dc.w $6980
; ---------------------------------------------------------------------------
; Pattern load cues - Labyrinth (UNUSED)
; ---------------------------------------------------------------------------
PLC_LZ:		dc.w $0
...
;		dc.w $A000
		...
		dc.w $A660
; ---------------------------------------------------------------------------
; Pattern load cues - Marble (Cold Gates Zone)
; ---------------------------------------------------------------------------
PLC_MZ:		dc.w 9
		...
		dc.w $68A0
		dc.l Nem_Swing		; swinging platform (UNSUED?)
		dc.w $7000
		dc.l Nem_MzGlass	; green	glassy block (UNUSED)
		dc.w $71C0
		dc.l Nem_Ball		; giant	ball (UNUSED)
		dc.w $7540
		dc.l Nem_Orbinaut	; orbinaut enemy
		...
		dc.w $9FE0
PLC_MZ2:	dc.w 4
		dc.l Nem_MzSwitch	; switch (UNUSED)
		dc.w $A260
		dc.l Nem_Spikes		; spikes
		dc.w $A360
		dc.l Nem_HSpring	; horizontal spring
		...
		dc.l Nem_VSpring	; vertical spring
		dc.w $A660
		dc.l Nem_MzBlock	; green	stone block (UNUSED)
		dc.w $5700
; ---------------------------------------------------------------------------
; Pattern load cues - Star Light (Unused)
; ---------------------------------------------------------------------------
PLC_SLZ:	dc.w 0
...
;		dc.w $9E00
; ---------------------------------------------------------------------------
; Pattern load cues - Spring Yard (Pepsi City Zone)
; ---------------------------------------------------------------------------
PLC_SYZ:	dc.w 3
		dc.l Nem_SYZ		; SYZ main patterns
		dc.w 0
		dc.l Nem_Bomb		; bomb enemy (obj5F)
		dc.w $8000
		dc.l Nem_Orbinaut	; orbinaut enemy (obj60)
		dc.w $8520
		dc.l Nem_Yadrin		; yadrin enemy
		dc.w $8F60
PLC_SYZ2:	dc.w 7
		...
		dc.w $A660
; ---------------------------------------------------------------------------
; Pattern load cues - Scrap Brain (Unused)
; ---------------------------------------------------------------------------
PLC_SBZ:	dc.w $0
...
;		dc.l Nem_Bomb		; bomb enemy
;		dc.w $8000
;		dc.l Nem_Buzz		; buzz bomber enemy (UNUSED)
;		dc.w $8880
...
PLC_Warp:	dc.w 0
		...
		dc.w $A820
; ---------------------------------------------------------------------------
; Pattern load cues - special stage (ultra unused)
; ---------------------------------------------------------------------------
...
;If whomever is doing this stuff wants to save stuff I guess they could get rid of the animals since we dont really need them anyways
; ---------------------------------------------------------------------------
...
PLC_SBZAnimals:	dc.w 1
		...
		dc.w $B240
; ---------------------------------------------------------------------------
; Pattern load cues - special stage results screen (unused)
; ---------------------------------------------------------------------------
PLC_SpeStResult:dc.w 1
		...
		dc.w $AA20
; ---------------------------------------------------------------------------
; Pattern load cues - ending sequence (literally all of this is unused lol)
; ---------------------------------------------------------------------------
PLC_Ending:	dc.w $E
...
PLC_FZBoss:	dc.w 4
		...
		dc.w $A540
; ---------------------------------------------------------------------------
; Pattern load cues - Egg Plant Zone
; ---------------------------------------------------------------------------
PLC_EPZ:	dc.w $A
		dc.l Nem_EPZ		; GHZ main patterns
		dc.w 0
		dc.l Nem_Stalk		; flower stalk
		dc.w $6B00
		dc.l Nem_PplRock	; purple rock
...
PLC_EPZAnimals:	dc.w 1
		...
		even
; ---------------------------------------------------------------------------
; Pattern load cues - Island Nowhere
; ---------------------------------------------------------------------------
PLC_INZ:	dc.w 8	; UT: Make sure that if you change the amount of stuff being used, make sure to change this value!
		dc.l Nem_INZ		; GHZ main patterns
		dc.w 0
;		dc.l Nem_Stalk		; flower stalk
;		dc.w $6B00
;		dc.l Nem_PplRock	; purple rock
